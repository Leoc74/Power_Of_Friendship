  ...
  if (ksbio === null) {
    ...
    div.appendChild(
      document.createTextNode(
        "Kevin, a junior CS and Math major from North Reading, Massachusetts, ensures clear and concise functions and code, maintains brief but informative commenting, and most importantly, allows for easy understanding and readability for both technical and non-technical audiences."
      )
    );
...
aginfobutton.addEventListener("click", () => {
  ...
  if (agbio === null) {
    ...
    div.appendChild(
      document.createTextNode(
        "Amira Garba is a senior from Peabody, MA, majoring in Informatics and minoring in Computer Science. As a front-end developer, she is passionate about crafting user friendly websites that seamlessly blend aesthetics with functionality. With expertise in HTML, CSS, and JavaScript, Amira transforms design concepts into intuitive interfaces optimized for diverse devices. Collaborative and detail oriented, she thrives on pushing the boundaries of web development while prioritizing user satisfaction and engagement."
      )
    );
