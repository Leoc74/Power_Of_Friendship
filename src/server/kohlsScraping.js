...
async function fetchProductData() {
    try {
        ...
        const response = await fetch('https://www.kohls.com/catalog/mens-clothing.jsp?CN=Gender:Mens+Department:Clothing&cc=mens-TN1.0-S-men&kls_sbp=90330586387737637469065939933071974599&PPP=48&WS=48&S=1&sks=true&spa=1&ajax=true&gNav=false');
