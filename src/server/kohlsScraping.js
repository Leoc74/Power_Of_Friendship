...
const urlList = {
  women:
    "https://www.kohls.com/catalog/womens-clothing.jsp?CN=Gender:Womens+Department:Clothing&cc=wms-TN2.0-S-womensclothing&kls_sbp=90330586387737637469065939933071974599&PPP=48&WS=48&S=1&sks=true&spa=1&ajax=true&gNav=false",
...
export async function scrapeKohls(search, filter = "all") {
  try {
    let urls;
    if (
      filter === "all" ||
      !urlList.hasOwnProperty(filter) ||
      urlList[filter] === null
    ) {
