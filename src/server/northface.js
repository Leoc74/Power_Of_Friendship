...
async function scrapeNorthFace() {
    try {
        ...
        const response = await fetch('https://www.thenorthface.com/api/products/v1/catalog?start=24&count=24&sort=bestMatches&locale=en-us&filters=cgid=359774&fqj=%7B%22cgid%22%3A%22359774%22%7D');
